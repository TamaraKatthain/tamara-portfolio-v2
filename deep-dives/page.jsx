  ...
  return (
    <main className="app-container min-h-screen">
      ...
      <section className="space-y-20 max-w-3xl">
        ...
        <div className="space-y-4 border-b border-[#2F8EDC]/20 pb-12">
        ...
        <div className="space-y-4 border-b border-[#2F8EDC]/20 pb-12">
          ...
          <p>
            Twenty-six episodes later, the finale delivers emotional chaos and a reflection on toxic relationship cycles.
          </p>
        </div>
